...
function App() {
  return (
    <>
      <div className="w-full h-screen bg-gradient-to-tr from-white via-slate-400 to-black">
        ...
        <div className="absolute grid grid-cols-2 grid-rows-2 gap-6 transform -translate-x-1/2 bottom-0 translate-y-1/2 left-1/2">
